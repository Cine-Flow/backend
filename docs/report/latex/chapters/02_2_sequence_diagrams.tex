...
\textbf{16. UC-16: Đánh dấu phim yêu thích}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/outputs/seq/UC-16.png}
    \caption{Sơ đồ Tuần tự: UC-16 Đánh dấu phim yêu thích}
    \label{fig:seq_uc_16}
\end{figure}

\textbf{17. UC-17: Bình luận phim và video ngắn}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/outputs/seq/UC-17.png}
    \caption{Sơ đồ Tuần tự: UC-17 Bình luận phim và video ngắn}
    \label{fig:seq_uc_17}
\end{figure}

\textbf{18. UC-18: Lưu lịch sử và tiến trình xem}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/outputs/seq/UC-18.png}
    \caption{Sơ đồ Tuần tự: UC-18 Lưu lịch sử và tiến trình xem}
    \label{fig:seq_uc_18}
\end{figure}

\textbf{19. UC-19: Quản lý hồ sơ người dùng}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/outputs/seq/UC-19.png}
    \caption{Sơ đồ Tuần tự: UC-19 Quản lý hồ sơ người dùng}
    \label{fig:seq_uc_19}
\end{figure}
